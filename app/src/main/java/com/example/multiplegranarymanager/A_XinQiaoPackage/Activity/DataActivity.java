...
public class DataActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private List<HistoryCountMultipleBean.DataContent> DataContent;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DataContent = bundle.getParcelableArrayList("数据");
        Log.d("jht", "onCreate: "+DataContent.get(0).getTempList());
        TXT_name.setText(DataContent.get(0).getGranarySetting().getName());

        suoPingDialog = new SuoPingDialog(this,"加载中,请稍等......");
        suoPingDialog.show();
        initDrawTable(date, DataContent.get(0), new OnInitDrawTableFinishedListener() {
            @Override
        ...
        switch (v.getId()) {
            case R.id.select:
                ...
                for (int i=0;i<DataContent.size();i++) {
                    name.add(DataContent.get(i).getGranarySetting().getName());
                    if (DataContent.get(i).getGranarySetting().getName().equals(TXT_name.getText())) {
                        selectWhich = i;
                    }
                }
                ArrayAdapter adapter_this = new ArrayAdapter<String>(DataActivity.this,R.layout.simple_list,name);
                ...
                builder.setSingleChoiceItems(adapter_this, selectWhich, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        selectWhich = which;
                        TXT_name.setText(DataContent.get(which).getGranarySetting().getName());
                        suoPingDialog = new SuoPingDialog(DataActivity.this,"加载中,请稍等......");
                        suoPingDialog.show();
                        initDrawTable(date, DataContent.get(which), new OnInitDrawTableFinishedListener() {
                            @Override
                            public void OnInitDrawTableListener(boolean success) {
                                suoPingDialog.dismiss();
                            }
                    ...
                    if (i==0&&j==0){
                        ...
                        for (int a=0;a<lan;a++){
                            ...
                            if (optionalMax.isPresent()){
                                ...
                                cell.setText(df.format(rowIndex));
                            } else {
                                cell.setText("断路");
                                cell.setTextColor(getResources().getColor(android.R.color.holo_red_dark));
                            }
                    ...
                    for (int j=0;j<8;j++){
                        ...
                        if (i==0&&j==0){
                            ...
                            if (tempList.getTempInner()!=null){
                                cell.setText(df.format(tempList.getTempInner())+"℃");
                            } else {
                                cell.setText("————");
                            }
                        } else if (i==0&&j==2) {
                            ...
                            if (tempList.getHumidityInner()!=null){
                                cell.setText(df.format(tempList.getHumidityInner())+"%");
                            } else {
                                cell.setText("————");
                            }
                        } else if (i==0&&j==4) {
                            ...
                            if (tempList.getTempOut()!=null){
                                cell.setText(df.format(tempList.getTempOut())+"℃");
                            } else {
                                cell.setText("————");
                            }
                        } else if (i==0&&j==6) {
                            ...
                            if (tempList.getHumidityOut()!=null){
                                cell.setText(df.format(tempList.getHumidityOut())+"%");
                            } else {
                                cell.setText("————");
                            }
                        }
