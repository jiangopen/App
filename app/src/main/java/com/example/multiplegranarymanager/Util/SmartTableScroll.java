...
public class SmartTableScroll<T> extends View implements OnTableChangeListener{
    ...
    public SmartTableScroll(Context context) {
        super(context);
        init();
    }

    public SmartTableScroll(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public SmartTableScroll(Context context, AttributeSet attrs, int defStyleAttr) {
