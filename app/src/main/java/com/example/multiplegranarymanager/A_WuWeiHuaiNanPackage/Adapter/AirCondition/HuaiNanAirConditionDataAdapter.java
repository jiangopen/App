package com.example.multiplegranarymanager.A_WuWeiHuaiNanPackage.Adapter.AirCondition;


import static com.example.multiplegranarymanager.A_WuWeiHuaiNanPackage.Activity.AirConditionActivity.intToHex;
...
import com.example.multiplegranarymanager.A_WuWeiHuaiNanPackage.Bean.AirCondition.AirConditionStatusBean;
...
public class HuaiNanAirConditionDataAdapter extends MultiLayoutAdapter<CardAirConditionAdapterBody> implements SectionIndexer, View.OnClickListener {
    ...
    public HuaiNanAirConditionDataAdapter(ArrayList<CardAirConditionAdapterBody> mDatas, int[] layoutIds, Context context) {
    ...
    protected void coverts(BaseViewHolder holder, CardAirConditionAdapterBody item, int position, int itemType) {
        if (item!=null){
            ...
            if (item.getStatus()==null){
                ...
                holder.setText(R.id.txt_status_num,"送风");
