package com.example.multiplegranarymanager.A_WuWeiHuaiNanPackage.Adapter.Wind.HuaiNan;
    ...
    public void onClick(View v) {
        ...
        if (v.getId()== R.id.txt_open){
            ...
            if (item.getHardwareStatus().equals("02")||item.getHardwareStatus().equals("45")){
                Log.d("ZYQJHT", "onClick: "+item.getHardwareData().getName());
            ...
            } else if(item.getHardwareStatus().equals("02")||item.getHardwareStatus().equals("45")){
            ...
            if (item.getHardwareStatus().equals("45")){
                Log.d("ZYQJHT", "onClick: "+item.getHardwareData().getName());
                util.showToast(context,"已开，请不要重复操作！");
            } else if (item.getHardwareStatus().equals("01")||item.getHardwareStatus().equals("02")){
                body+=
                         "03"
                        + "FFFF0D0A";
                countMultiple.setCommandContent(body);
